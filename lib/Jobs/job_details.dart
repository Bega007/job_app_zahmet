...
import 'package:jobappfirebase/Services/global_variables.dart';
import 'package:jobappfirebase/Widgets/comments_widget.dart';
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            icon: const Icon(Icons.close, size: 40, color: Colors.amber,),
            onPressed: ()
            {
